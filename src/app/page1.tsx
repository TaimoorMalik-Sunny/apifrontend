...
export default function Home() {
  ...
  const [isfourthmodal, setIsfourthmodal] = useState(false);

  const [isfifthmodal, setIsfifthmodal] = useState(false);
  
  const [issixmodal, setIssixmodal] = useState(false);

  const [issevenmodal, setIssevenmodal] = useState(false);
  ...
  const nextModal1 = () => {
    ...
    setIsSeconmodal(true)

  
  };
  
  const nextModal2 = () => {
    setIsSeconmodal(false)
    setIsthirdmodal(true)
  
  };
  const nextModal3 = () => {
    setIsthirdmodal(false)
    setIsfourthmodal(true)
  
  };
  
  const nextModal4 = () => {
    setIsfourthmodal(false)
    setIsfifthmodal(true)
  
  };
  const nextModal5= () => {
    setIsfifthmodal(false)
    setIssixmodal(true)
  
  };
  const nextModal6= () => {
    setIssixmodal(false)
    setIssevenmodal(true)
  ...
  return (
    ...
    <>
      ...
      {isthirdmodal && 
          ...
          <img src="ButtoncloseX.svg" alt="Image wrap" className="mt-0" />
                ...
                <div className='flex-col justify-center mt-2 '>
                  ...
                  <button className=" bg-white   text-white font-bold py-2 px-4 rounded" onClick={nextModal3}>
      ...
      {isfourthmodal && 
                    ...
                    <img src="fourthscreenimg.svg" alt="Image wrap" className="mt-4" onClick={nextModal4} />
      ...
      <div className='flex-col justify-between'>
        ...
        <img src="fifthcontinueButton.svg" alt="Image wrap" className="mt-4" onClick={nextModal5} />
...
<img src="sixButtonconfirm.svg" alt="Image wrap" className="mt-0" onClick={nextModal6}/>
